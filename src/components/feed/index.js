...
// const Feed = ({ profileInfo, user, allFeedPosts }) => {
...
//               className="flex items-center justify-center h-11 px-5"
//             >
//               Add New Post
//             </Button>
//           </div>
...
//             placeholder="Share Your Knowledge & Thoughts..."
//             className="border-none outline-none focus-visible:ring-0 focus-visible:ring-offset-0 h-[350px] text-[25px]"
//           />

//           <div className="flex gap-5 items-center justify-between">
//             <Label for="imageURL" className="cursor-pointer">
//               <CirclePlus />
//               <Input
...
//               className="disabled:opacity-75 flex items-center justify-center h-11 w-40 px-5"
//             >
//               Post
//             </Button>
//           </div>
